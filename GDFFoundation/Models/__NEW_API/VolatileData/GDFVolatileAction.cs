...
namespace GDFStandardModels
{
    ...
    public sealed class GDFVolatileAction : GDFVolatileData
    {
        ...
        /// </summary>
        /// <remarks>
        /// The ScreenPositionY property represents the vertical position of the screen where the action occurs. </remarks>
        ...
        /// </summary>
        public GDFVolatileAction() : base() { }
        
        /// <summary>
        /// The GDFVolatileAction class represents a volatile action in a specific scene.
        /// </summary>
        public GDFVolatileAction(IGDFVolatileAgent sVolatileManager, string sCategory, string sScene, string sActionFor, GDFVector2 sScreen, GDFVector2 sScreenPosition, GDFVector3 sWorldPosition, string sInformation) : base(sVolatileManager, sCategory, sInformation)
        {
            Scene = sScene;
        ...
        /// </summary>
        public GDFVolatileAction(IGDFVolatileAgent sVolatileManager, Enum sCategory, string sScene, string sActionFor, GDFVector2 sScreen, GDFVector2 sScreenPosition, GDFVector3 sWorldPosition, string sInformation) : base(sVolatileManager, sCategory, sInformation)
        {
            Scene = sScene;
            ActionFor = sActionFor;
