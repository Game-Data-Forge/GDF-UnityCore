...
namespace GDFFoundation
{
    ...
    public class GDFAccountService : GDFAccountData, IComparable<GDFAccountService>
    {
        ...
        /// </summary>
        public GDFAccountService(long sProjectReference, GDFEnvironmentKind sEnvironmentKind, long sAccount, long sService, DateTime sStart, DateTime sEnd, string sMessage = "", GDFBootstrapKindOfStyle sMessageStyle = GDFBootstrapKindOfStyle.Primary)
        {
            if (Message == null)
            {
                Message = "";
        ...
        /// Represents an account service in the GDFFoundation.
        /// </summary>
        public GDFAccountService(long sProjectReference, GDFEnvironmentKind sEnvironmentKind, long sAccount, long sService, long sStart, long sEnd, string sMessage = "", GDFBootstrapKindOfStyle sMessageStyle = GDFBootstrapKindOfStyle.Primary)
        {
            Project = sProjectReference;
            Status = GDFAccountServiceStatus.IsActive;
            Start = sStart;
        ...
        /// <returns>Returns an integer value that indicates the relative order of the objects being compared. The return value has the following meanings:
