...
// GDFFoundation.csproj IGDFWebDaoGeneric.cs create at 2025/03/26 17:03:59
...
namespace GDFFoundation
{
    ...
    public interface IGDFWebDaoGeneric : IGDFAbstractDao
    {
        ...
        public T Create<T>(ProjectEnvironment sEnvironment, long sProjectReference, T sModel, bool sWithNewReference) where T : GDFLocalWebData;
        ...
        public void CreateTable<T>(ProjectEnvironment sEnvironment) where T : GDFLocalWebData;
        ...
        public bool Delete<T>(ProjectEnvironment sEnvironment, long sProjectReference, T sObject) where T : GDFLocalWebData;
        ...
        public bool Delete<T>(ProjectEnvironment sEnvironment, long sProjectReference, long sReference) where T : GDFLocalWebData;
        ...
        public void DeleteTable<T>(ProjectEnvironment sEnvironment) where T : GDFLocalWebData;
        ...
        public List<T> FindAll<T>(ProjectEnvironment sEnvironment, long sProjectReference) where T : GDFLocalWebData;
        ...
        public List<T> FindAllModified<T>(ProjectEnvironment sEnvironment, long sProjectReference, long sSyncDate) where T : GDFLocalWebData;
        ...
        public string FingerPrintTable<T>(ProjectEnvironment sEnvironment) where T : GDFLocalWebData;
        ...
        public string FingerPrintTableName<T>(ProjectEnvironment sEnvironment) where T : GDFLocalWebData;
        ...
        public List<T> GetBy<T>(ProjectEnvironment sEnvironment, long sProjectReference, List<GDFDatabaseWhereModel> sWhereClause) where T : GDFLocalWebData;
        ...
        public T GetFirstBy<T>(ProjectEnvironment sEnvironment, long sProjectReference, List<GDFDatabaseWhereModel> sWhereClause) where T : GDFLocalWebData;
        ...
        public T InsertOrUpdate<T>(ProjectEnvironment sEnvironment, long sProjectReference, T sModel, bool sWithNewReference) where T : GDFLocalWebData;
        ...
        public long NewValidReference<T>(ProjectEnvironment sEnvironment, long sProjectReference) where T : GDFLocalWebData;
        ...
        public bool TableExists<T>(ProjectEnvironment sEnvironment) where T : GDFLocalWebData;
        ...
        public bool TestIfReferenceExists<T>(ProjectEnvironment sEnvironment, long sProjectReference, long sReference) where T : GDFLocalWebData;
