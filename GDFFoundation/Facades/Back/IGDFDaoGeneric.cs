...
namespace GDFFoundation
{
    ...
    public interface IGDFDaoGeneric : IGDFAbstractDao
    {
        ...
        public bool TableExists<T>(GDFEnvironmentKind sEnvironment) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public void CreateTable<T>(GDFEnvironmentKind sEnvironment) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public void DeleteTable<T>(GDFEnvironmentKind sEnvironment) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        /// </remarks>
        public void CreateIndex<T>(GDFEnvironmentKind sEnvironment) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        /// </remarks>
        public void DeleteIndex<T>(GDFEnvironmentKind sEnvironment) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public T Create<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, T sModel, bool sRangeDependent, bool sWithNewReference) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public T Update<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, T sModel, List<GDFDatabaseWhereModel> sWhereClause) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public bool Delete<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, T sModel) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public bool Delete<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, long sReference) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public List<T> FindAll<T>(GDFEnvironmentKind sEnvironment, long sProjectReference) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        /// </remarks>
        public List<T> FindAllModified<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, long sSyncDate)
        ...
        public T InsertOrUpdate<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, T sModel, bool sRangeDependent,
            bool sWithNewReference, List<GDFDatabaseWhereModel> sWhereClause) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public List<T> GetBy<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, List<GDFDatabaseWhereModel> sWhereClause) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public long Sum<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, string sColumn, List<GDFDatabaseWhereModel> sWhereClause) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public long Count<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, List<GDFDatabaseWhereModel> sWhereClause) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public T GetByReference<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, string sReference) where T : GDFBasicData, IGDFWritableLongReference;
        ...
        public T GetFirstBy<T>(GDFEnvironmentKind sEnvironment, long sProjectReference, List<GDFDatabaseWhereModel> sWhereClause) where T : GDFBasicData, IGDFWritableLongReference;
    }
}
