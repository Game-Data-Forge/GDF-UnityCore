...
namespace GDFFoundation
{
    ...
    public abstract class GDFGenericEnum : IComparable
    {
        ...
        /// - a positive integer if this instance is greater than <paramref name="sOther"/>.</returns>
    ...
    public abstract class GDFGenericEnumGeneric<T> : GDFGenericEnum where T : GDFGenericEnumGeneric<T>, new()
    {
        ...
        /// <summary>
        /// Return static instance for the given long value. </summary> <param name="sId">The long value used to get the instance.</param> <returns>The instance of type T, or null if not found.</returns>
        /// /
