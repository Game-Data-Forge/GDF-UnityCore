...
namespace GDFFoundation
{
    ...
    public static class GDFSecurityTools
    {
        ...
        public static string CryptSomething(string sRescueToken, long sProjectReference, GDFEnvironmentKind sEnvironmentKind, IGDFSecretKey sSecretKeyManager, IGDFProjectKey sProjectKeyManager)
        {
        ...
        public static string DecryptSomething(string sRescueTokenSecured, long sProjectReference, GDFEnvironmentKind sEnvironmentKind, IGDFSecretKey sSecretKeyManager, IGDFProjectKey sProjectKeyManager)
        {
            if (sSecretKeyManager != null && sProjectKeyManager != null)
            {
