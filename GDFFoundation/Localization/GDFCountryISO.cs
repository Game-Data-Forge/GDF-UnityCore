...
namespace GDFFoundation
{
    ...
    public class GDFCountryISO
    {
        ...
        public static readonly GDFCountryISO[] Countries = new[]
        {
            ...
            new GDFCountryISO("Austria", "AT", "AUT", "040", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Belgium", "BE", "BEL", "056", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Bulgaria", "BG", "BGR", "100", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Croatia", "HR", "HRV", "191", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Cuba", "CU", "CUB", "192", GDFDataArea.NorthAmerica),
            new GDFCountryISO("Curaçao", "CW", "CUW", "531", GDFDataArea.NorthAmerica),
            new GDFCountryISO("Cyprus", "CY", "CYP", "196", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Czechia", "CZ", "CZE", "203", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Denmark", "DK", "DNK", "208", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Estonia", "EE", "EST", "233", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Finland", "FI", "FIN", "246", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("France", "FR", "FRA", "250", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("French Guiana", "GF", "GUF", "254", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Germany", "DE", "DEU", "276", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Ghana", "GH", "GHA", "288", GDFDataArea.Africa),
            new GDFCountryISO("Gibraltar", "GI", "GIB", "292", GDFDataArea.European),
            new GDFCountryISO("Greece", "GR", "GRC", "300", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Guadeloupe", "GP", "GLP", "312", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Hungary", "HU", "HUN", "348", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Iceland", "IS", "ISL", "352", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Ireland", "IE", "IRL", "372", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Isle of Man", "IM", "IMN", "833", GDFDataArea.European),
            new GDFCountryISO("Israel", "IL", "ISR", "376", GDFDataArea.Asia),
            new GDFCountryISO("Italy", "IT", "ITA", "380", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Latvia", "LV", "LVA", "428", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Liechtenstein", "LI", "LIE", "438", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Lithuania", "LT", "LTU", "440", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Luxembourg", "LU", "LUX", "442", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Malta", "MT", "MLT", "470", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Marshall Islands", "MH", "MHL", "584", GDFDataArea.Oceania),
            new GDFCountryISO("Martinique", "MQ", "MTQ", "474", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Mauritania", "MR", "MRT", "478", GDFDataArea.Africa),
            new GDFCountryISO("Mauritius", "MU", "MUS", "480", GDFDataArea.Africa),
            new GDFCountryISO("Mayotte", "YT", "MYT", "175", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Monaco", "MC", "MCO", "492", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Netherlands", "NL", "NLD", "528", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Norway", "NO", "NOR", "578", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Poland", "PL", "POL", "616", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Portugal", "PT", "PRT", "620", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Puerto Rico", "PR", "PRI", "630", GDFDataArea.NorthAmerica),
            new GDFCountryISO("Qatar", "QA", "QAT", "634", GDFDataArea.Asia),
            new GDFCountryISO("Réunion", "RE", "REU", "638", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Romania", "RO", "ROU", "642", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Saint Barthélemy", "BL", "BLM", "652", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Saint Martin (French part)", "MF", "MAF", "663", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("San Marino", "SM", "SMR", "674", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Slovakia", "SK", "SVK", "703", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Slovenia", "SI", "SVN", "705", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Spain", "ES", "ESP", "724", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Svalbard and Jan Mayen", "SJ", "SJM", "744", GDFDataArea.European_GDPR_EU),
            new GDFCountryISO("Sweden", "SE", "SWE", "752", GDFDataArea.European_GDPR_EU),
            ...
            new GDFCountryISO("Åland Islands", "AX", "ALA", "248", GDFDataArea.European_GDPR_EU)
        };
    }
}